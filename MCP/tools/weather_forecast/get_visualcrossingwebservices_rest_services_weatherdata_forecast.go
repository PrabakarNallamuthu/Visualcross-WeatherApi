...
func Get_visualcrossingwebservices_rest_services_weatherdata_forecastHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		if val, ok := args["sendAsDatasource"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("sendAsDatasource=%v", val))
		}
		...
		url := fmt.Sprintf("%s/VisualCrossingWebServices/rest/services/weatherdata/forecast%s", cfg.BaseURL, queryString)
...
func CreateGet_visualcrossingwebservices_rest_services_weatherdata_forecastTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_VisualCrossingWebServices_rest_services_weatherdata_forecast",
		mcp.WithDescription("Weather Forecast API"),
		mcp.WithBoolean("sendAsDatasource", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_visualcrossingwebservices_rest_services_weatherdata_forecastHandler(cfg),
	}
}
