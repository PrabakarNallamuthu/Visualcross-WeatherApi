...
func Get_visualcrossingwebservices_rest_services_timeline_locationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/VisualCrossingWebServices/rest/services/timeline/%s%s", cfg.BaseURL, location, queryString)
...
func CreateGet_visualcrossingwebservices_rest_services_timeline_locationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_VisualCrossingWebServices_rest_services_timeline_location",
		mcp.WithDescription("Historical and Forecast Weather API"),
		mcp.WithString("location", mcp.Required(), mcp.Description("Locaton of interest as an address, partial address or decimal latitude,longtude value")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_visualcrossingwebservices_rest_services_timeline_locationHandler(cfg),
	}
}
