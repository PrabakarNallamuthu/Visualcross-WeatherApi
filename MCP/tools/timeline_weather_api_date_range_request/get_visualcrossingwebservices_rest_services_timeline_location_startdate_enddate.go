...
func Get_visualcrossingwebservices_rest_services_timeline_location_startdate_enddateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		enddateVal, ok := args["enddate"]
		if !ok {
			return mcp.NewToolResultError("Missing required path parameter: enddate"), nil
		}
		enddate, ok := enddateVal.(string)
		if !ok {
			return mcp.NewToolResultError("Invalid path parameter: enddate"), nil
		}
		...
		url := fmt.Sprintf("%s/VisualCrossingWebServices/rest/services/timeline/%s/%s/%s%s", cfg.BaseURL, location, startdate, enddate, queryString)
...
func CreateGet_visualcrossingwebservices_rest_services_timeline_location_startdate_enddateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_VisualCrossingWebServices_rest_services_timeline_location_startdate_enddate",
		...
		mcp.WithString("enddate", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_visualcrossingwebservices_rest_services_timeline_location_startdate_enddateHandler(cfg),
	}
}
