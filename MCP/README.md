# Visual Crossing Weather API MCP Server

This MCP (Model Content Protocol) server provides access to Visual Crossing Weather API API functionality through HTTP, HTTPS, and STDIO transport modes.
